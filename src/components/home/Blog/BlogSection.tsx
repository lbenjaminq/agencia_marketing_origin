...
function BlogSection() {
  return (
    <div className="bg-white px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28 border">
      <div className="relative mx-12 max-w-full divide-y-2 divide-gray-200 lg:max-w-7xl">
        <div>
